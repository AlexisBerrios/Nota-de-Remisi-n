...
public class Productos extends JDialog {
   ...
   public Productos(NotadeRemision parent, boolean modal) {
      super(parent, modal);
      this.parent = parent;
      this.initComponents();
   ...
   private void initComponents() {
      ...
      this.jLabel1.setText("Elija la vestimenta ");
      ...
      ComboRopa.setFont(new Font("Impact", 0, 12));
      ComboRopa.setModel(new DefaultComboBoxModel(new String[]{"Elija la clave del Articulo ", "0001: Reloj Hilfiger ", "0002: Chaqueta Cafe ", "0003: Tenis Adidas", "0004: Mochila Negra ", "0005: Traje Negro", "0006: Cartera Café ", "0007: Sudadera blanco y negro ", "0008: Botas Negras ", "0009: Cinturón Negro ", "0010: Pans Negro "}));
      ComboRopa.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent evt) {
            Productos.this.ComboRopaActionPerformed(evt);
         }
      });
      ...
      ComboUnidadMedida.setFont(new Font("Impact", 0, 12));
      ComboUnidadMedida.setModel(new DefaultComboBoxModel(new String[]{"Elija la unidad de medida ", "Pieza", "Tonelada", "Kilogramos"}));
      ...
      txtprecio.addFocusListener(new FocusAdapter() {
         public void focusLost(FocusEvent evt) {
            Productos.this.txtprecioFocusLost(evt);
         }
      });
      txtprecio.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent evt) {
            Productos.this.txtprecioActionPerformed(evt);
         }
      });
      ...
      txtImporte.addFocusListener(new FocusAdapter() {
         public void focusLost(FocusEvent evt) {
            Productos.this.txtImporteFocusLost(evt);
         }
      });
      ...
      this.btagregar.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent evt) {
            Productos.this.btagregarActionPerformed(evt);
         }
      });
      ...
      this.jButton2.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent evt) {
            Productos.this.jButton2ActionPerformed(evt);
         }
      });
   ...
   private void btagregarActionPerformed(ActionEvent evt) {
      ...
      if (tot == 0.0D) {
         if (meses >= 1.0D) {
            NotadeRemision.txtsubtotal.setText(Imp + " ");
            Imp2 = Imp / meses;
            NotadeRemision.txtcuota.setText(Imp2 + " ");
            Imp3 = Double.parseDouble(NotadeRemision.txtsubtotal.getText());
            Subtotal = Imp3 * 0.16D;
            NotadeRemision.txtIVA.setText(Subtotal + " ");
            Iva = Subtotal + Imp3;
            NotadeRemision.txttotal.setText(Iva + "");
         } else if (meses == 0.0D) {
            NotadeRemision.txtsubtotal.setText(Imp + " ");
            Imp2 = Double.parseDouble(NotadeRemision.txtsubtotal.getText());
            Imp3 = Imp2 * 0.16D;
            NotadeRemision.txtIVA.setText(Imp3 + " ");
            Subtotal = Imp3 + Imp2;
            NotadeRemision.txttotal.setText(Subtotal + "");
         }
      } else if (tot >= 1.0D) {
         double total;
         if (meses >= 1.0D) {
